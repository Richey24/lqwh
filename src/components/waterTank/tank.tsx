...
function Index(props: any) {
  ...
  useEffect(() => {
      ...
      class AnalogTank {
        constructor($this: any, config: any) {
          const defaults = {
            ...
            defaultFillColor: props.color, // default water color. this is assigned to fillColor if water level does not pass any thresholds.
            ...
            fillMaxValue: props.fillMaxValue, // maximum possible value for the main text.
            ...
            fontWeight: "bold",
            fontSize: 20,
            backFontColor: props.fontColorBac,
    ...
    let tank = $('.'+props.clName).analogTank(options);
    ...
    function shrink() {
      document.getElementsByClassName(props.clName)[0].setAttribute("style", "width:200px;height:200px;");
      tank.redraw();
    }
    function enlarge() {
      document.getElementsByClassName(props.clName)[0].setAttribute("style", "width:400px;height:400px;");
      tank.redraw();
    }
    function high() {
    ...
    return(
        <>
            <div className="text-center">
                ...
                <h4>{props.title}</h4>
                <p>Size: {props.fillMaxValue}</p>
                
                <div id="wrapper" className={props.clName}>
                </div>
                <div className="form-group">
                    <div class="row mt-1">
                        <label for="colFormLabelSm" className="col-sm-4 col-form-label col-form-label-sm pull-right"><small>Batch#</small></label>
                        <div className="col-sm-8">
                            <input type="text" value="2323020" className="form-control form-control-sm" id="colFormLabelSm" placeholder="col-form-label-sm" />
                        </div>
                    </div>
                    {/* <input type="text" className="form-control input-sm" value={props.batch}ßß /> */}
